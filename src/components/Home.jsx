...
function Home({ color }) {
  return (
    <div className="sm:grid min-h-screen flex flex-col" style={{ backgroundColor: color ? "#E8F9FD" : 'rgba(26, 32, 44, 0.8)', gridTemplateColumns: '25% 45% 30%' }}>
      <div></div>
      <div className='sm:grid sm:grid-cols-2 capitalized relative w-full relative top-[50px]' style={{ color: color ? '#1a202ccc' : 'white' }} >
        ...
        <div className='w-[70%] sm:w-full sm:mt-0 mx-auto mt-8'>
